...
\begin{titlingpage}
  ...
  \begin{center}%
    ...
    \vskip 3em%
    {\lineskip .75em%
        \copyright\ 2006-2007 \OP.  All Rights Reserved.
    }
    \vskip 1.5em%
    {\large $Date$ \par}
  \end{center}
...
consider na\"ive set theory, which is what most people have learnt in school.
...
always be split into smaller items, or the set can be finite.  For our
purposes the number of gains of sand on the sea shore falls into the first
class, the possible lengths of a piece of string into the second, and the
pages of a book into the third.  In computer science sets are always finite,
since computers don't like dealing with infinite numbers.
...
multisets above should have been written as $[T,$ $H,$ $T,$ $H,$ $H]$.  Items
